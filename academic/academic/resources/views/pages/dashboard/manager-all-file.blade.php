...
<div class="col-md-3">
                                ...
                                <div class="main-card mb-3 card">
                                        <div id="add-option" class="card-body"><h5 class="card-title">Filter</h5>
                                            ...
                                            <div class="position-relative form-group"><label for="exampleCustomSelect" class="">Faculty</label>
                                            <select type="select" id="sl-faculty" name="customSelect" class="custom-select">
                                                <option value="0">select</option>
                                                <option value="0">All topic</option>

                                                @foreach($faculty as $lst)  
                                                <option value="{{$lst['id']}}">{{$lst['name']}}</option>                                         
                                                @endforeach                                             
