...
<div class="col-md-12 d-flex justify-content-center">
                                        ...
                                        <div class="main-card mb-12 card">
                                            ...
                                            <form id="loginf" action="{{ url('login') }}" method="POST" role="form">
                                            {{ csrf_field()}}
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"><span class="input-group-text">E-mail </span></div>
                                                        <input id="email" name="user" placeholder="User name or E-mail" type="text" class="form-control"></div>
                                                    <br>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"><span class="input-group-text">Password</span></div>
                                                        <input id="passwd" name="passwd" placeholder="Password" type="password" class="form-control"></div>
